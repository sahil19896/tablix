...
// serve socketio
http.listen(conf.tablix_socketio_port, function(){
  console.log('listening on *:', conf.tablix_socketio_port);
});
...
io.on('connection', function(socket){
	...
	socket.on('navdeep', function(data){
...
subscriber.subscribe("events", function(channel, count){
	console.log(count);
});
