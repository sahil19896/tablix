...
<img class="screenshot" alt="Create Customer" src="/docs/assets/img/tablix/desktop/Selling.png">

> Desktop > Selling > Customer

<img class="screenshot" alt="Create Customer" src="/docs/assets/img/tablix/customer/Customer_Main_Page.png">

> Desktop > Selling > Customer > New 

<img class="screenshot" alt="Create Customer" src="/docs/assets/img/tablix/customer/Customer_list.png">

> Customer Form

<img class="screenshot" alt="Create Customer" src="/docs/assets/img/tablix/customer/Customer1.png">
<img class="screenshot" alt="Create Customer" src="/docs/assets/img/tablix/customer/Customer2.png">
<img class="screenshot" alt="Create Customer" src="/docs/assets/img/tablix/customer/Customer3.png">
<img class="screenshot" alt="Create Customer" src="/docs/assets/img/tablix/customer/Customer4.png">
<img class="screenshot" alt="Create Customer" src="/docs/assets/img/tablix/customer/Customer5.png">
...
[Contacts and Addresses](/docs/user/manual/en/CRM/contact.html) in System are stored separately so that you can
...
In System, there is a separate Account record for each Customer, for each
Company.

When you create a new Customer, System will automatically create an Account
...
System allows you to group your Customers using [Customer Group](/docs/user/manual/en/CRM/setup/customer-group.html)
