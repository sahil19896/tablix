...
The terminology of 'Warehouse" in System is a bit broader though and maybe can be 
...
Every Warehouse must belong to a specific company, to maintain
...
> Note: System maintains stock balance for every distinct combination
