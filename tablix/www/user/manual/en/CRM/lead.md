...
#Step 1:
To create a Lead, go to desktop and click on highlighted link:
<img class="screenshot" alt="lead" src="/docs/assets/img/tablix/desktop/CRM.png">

#Step 2:
Click on Lead
<img class="screenshot" alt="Lead" src="/docs/assets/img/tablix/lead/Lead_Main_Page.png">


#Step 3:
Open exiting lead if you want to modify it/
Click on new Button to crate a lead

<img class="screenshot" alt="Lead" src="/docs/assets/img/tablix/lead/List_List.png">

#Step 4:

<img class="screenshot" alt="Lead" src="/docs/assets/img/crm/lead.png">

ERP gives you a lot of options you may want to store about your Leads. For
...
> **Tip:** ERP makes it easy to follow-up on leads by updating the “Next
